...
function BlogPostCard({ img, title, desc, url }: BlogPostCardPropsType) {
  return (
        ...
        <div className="container mx-auto px-8 py-10">
          <div className="mb-16 text-left">
            ...
            <Typography color="blue-gray">
              {desc ||
                "Explore our example pages to see how you can use our components to create stunning web applications."}
            </Typography>
          </div>
